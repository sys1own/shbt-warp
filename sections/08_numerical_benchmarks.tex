...
The Rust/PyO3 simulator (\path{src/} core, exposed through the
\path{python/shbt_warp/} package) implements the finite
...
\begin{table}[b]
  \centering
  \caption{Numerical output of the SHBT warp simulator.}\label{tab:engine-benchmarks}
  \begin{tabular}{lc}
    \toprule
...
exported directly from the Rust/PyO3 pipeline into \path{sim_results.tex} and
