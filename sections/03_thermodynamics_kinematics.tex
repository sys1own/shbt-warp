...
\end{equation}
The on-shell boundary condition, enforced by the modular register implementation in \path{src/boundary.rs} and \path{src/shbt/character_excitation.rs} of the primary repository~\cite{shbt-precision}, is the constrained stationarity requirement
\begin{equation}
